...
public class MyBasicList<E> {
	...
	/**
	 * Count the number of occurrences of each item in a collection and return a
	 * collection of the counts
	 * 
	 * @param c
	 *            A collection of items - some of which may be duplicated
	 * @return A collection of Integers. Each integer represents the number of
	 *         occurrences of each of the corresponding item in the c
	 *         Collection.
	 */
