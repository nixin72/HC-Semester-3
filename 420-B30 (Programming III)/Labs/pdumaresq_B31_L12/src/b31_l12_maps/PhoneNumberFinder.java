...
public class PhoneNumberFinder extends JFrame {
	...
	private void searchFind_ActionPerformed(ActionEvent e) {
		String firstname = JOptionPane.showInputDialog(this, "Enter first name", "First name",
				JOptionPane.QUESTION_MESSAGE);
		String lastname = JOptionPane.showInputDialog(this, "Enter last name", "Last name",
				JOptionPane.QUESTION_MESSAGE);
		String phoneNumber = directory.lookupEntry(firstname, lastname);
		if (phoneNumber != null) {
			...
			JOptionPane.showMessageDialog(this, firstname + " " + lastname + "  is not in your phone directory",
					"No such person", JOptionPane.ERROR_MESSAGE);
	}

	private void addBtn_actionPerformed(ActionEvent e) {
		if (firstNameFld.getText().length() == 0)
			JOptionPane.showMessageDialog(this, "First name is missing", "Missing first name",
					JOptionPane.ERROR_MESSAGE);
		else if (lastNameFld.getText().length() == 0)
			JOptionPane.showMessageDialog(this, "Last name is missing", "Missing last name", JOptionPane.ERROR_MESSAGE);
		else if (lastNameFld.getText().length() == 0)
			JOptionPane.showMessageDialog(this, "Phone number is missing", "Phone number last name",
					JOptionPane.ERROR_MESSAGE);
		else {
			directory.addEntry(firstNameFld.getText(), lastNameFld.getText(), phoneFld.getText());
			JOptionPane.showMessageDialog(this,
					firstNameFld.getText() + " " + lastNameFld.getText() + " has been added", "Person Added",
	...
	private void changeBtn_actionPerformed(ActionEvent e) {
		if (firstNameFld.getText().length() == 0)
			...
			JOptionPane.showMessageDialog(this, "Phone number is missing", "Phone number last name",
					JOptionPane.ERROR_MESSAGE);
		else if (directory.changeEntry(firstNameFld.getText(), lastNameFld.getText(), phoneFld.getText()) != null)
			JOptionPane.showMessageDialog(this,
					"Phone number has been changed for " + firstNameFld.getText() + " " + lastNameFld.getText(),
					"Phone Number Changed", JOptionPane.INFORMATION_MESSAGE);
		else
			JOptionPane.showMessageDialog(this,
					firstNameFld.getText() + " " + lastNameFld.getText() + "  is not in your phone directory",
					"No such person", JOptionPane.ERROR_MESSAGE);
	}
	...
	private void deleteBtn_actionPerformed(ActionEvent e) {
		if (firstNameFld.getText().length() == 0)
			...
			if (directory.removeEntry(firstNameFld.getText(), lastNameFld.getText()) == null)
				JOptionPane.showMessageDialog(this,
						firstNameFld.getText() + " " + lastNameFld.getText() + "  is not in your phone directory",
						"No such person", JOptionPane.ERROR_MESSAGE);
			else {
				JOptionPane.showMessageDialog(this,
						firstNameFld.getText() + " " + lastNameFld.getText() + " has been deleted", "Person Deleted",
						JOptionPane.INFORMATION_MESSAGE);
				firstNameFld.setText("");
				lastNameFld.setText("");
				phoneFld.setText("");
