...
public class Temperature {
	...
	/**
	 * Construct a default Temperature object. The units default to Celsius and
	...
	/**
	 * Construct a Temperature object using the arguments. If the units are not
	 * valid, an illegal argument exception is thrown.
	 * 
	 * @param temp
	 *            the temperature measured in the scale specified by units
	 * @param type
	 *            the temperature scale. Valid values are:
	 *            <ul>
	 *            <li>'C' for Celsius
	 *            <li>'F' for Fahrenheit
	 *            </ul>
	 * @throws IllegalArgumentException
	 *             if the type is not 'C' or 'F'
	 */
	...
	/**
	 * Set the current scale for the temperature. If the units are not valid, an
